...
const faqs = [
  {
    ...
    answer:
      "A Bank Identification Number (BIN), also known as an Issuer Identification Number (IIN), is the first 6 to 8 digits of a payment card number. It identifies the institution that issued the card to the card holder.",
  },
  {
    question: "How accurate is the BIN data?",
    answer:
  ...
  {
    question: "Can I use BINList.io for free?",
    answer:
      "Yes, we offer a free tier that allows a limited number of lookups per month. For higher volume needs or commercial use, we offer paid plans with additional features and higher rate limits.",
  },
  {
    question: "How often is the BIN database updated?",
    answer:
      "We update our database on a weekly basis to ensure the most current information. Critical updates may be applied more frequently as needed.",
  },
  {
